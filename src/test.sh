...
#SBATCH --time=8:59:00  # D-HH:MM:SS
...
start_time=$(date +%s)
d=`date +%F-%H-%M-%S`
output="../data/gpu-quick-3${SLURM_JOB_ID}-$d.csv"
...
./q3  ../data/gm.csv ../data/gf.csv ../data/vnc_matching_submission_benchmark_5154247.csv $output
